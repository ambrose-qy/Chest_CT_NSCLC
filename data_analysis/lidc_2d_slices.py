...
def build_slice_manifest(
    ...
    for index, row in enumerate(selected_rows, start=1):
        ...
        output = {
            ...
            "majority_internal_structure": field_value(row, "majority_internal_structure"),
            "majority_calcification": field_value(row, "majority_calcification"),
            "majority_sphericity": field_value(row, "majority_sphericity"),
            "majority_margin": field_value(row, "majority_margin"),
            "majority_lobulation": field_value(row, "majority_lobulation"),
            "majority_spiculation": field_value(row, "majority_spiculation"),
            "majority_texture": field_value(row, "majority_texture"),
            "overall_consistency": field_value(row, "overall_consistency"),
